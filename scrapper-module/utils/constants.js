module.exports = {
  ...
  SCRAPPER_QUEUE: "scrapper-queue",
  MODEL_NAME: 'gemini-1.5-flash',
  FEMALE_KEYWORDS : [
    "femme", "femmes", "women", "lady", "ladies", "girl", "girls", "feminine", "woman", 
    "madame", "miss", "mademoiselle", "beauté", "beauty", "maquillage", "makeup"
  ],
  MALE_KEYWORDS : [
    "homme", "men", "man", "masculin", "monsieur", "gentleman", "gars", 
    "mec", "boy", "boys", "dude", "hommes"
  ],
  KIDS_KEYWORDS : [
    "enfant", "enfants", "kids", "baby", "bébé", "toddler", "garçon", "fille",
    "babies", "kid", "garçons", "filles"
  ],
};
